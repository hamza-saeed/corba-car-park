...
public class ExitClient extends JFrame {
    ...
    public static void main(String args[])
    {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ExitClient().setVisible(true);
            }
        });
    ...
    private void btnEnterMouseClicked(java.awt.event.MouseEvent evt) {
        ...
        exit.car_exited(txtReg.getText(),date,time);
    ...
    private static void setupClientServerConnections(String args[])
    {
        try {
            ...
            /* Make the exit gate client into a server
            ...
            ExitGateImpl.ExitGateName = gateName;

            /*Make the entry client into a client
            so that it can connect to the LocalServer. */

            // create servant and register it with the ORB
            exit = ExitGateHelper.narrow(nameServiceServer.resolve_str(gateName));
            ...
            exit.registerGate(gateName, stringified_ior);
