 ...
 implements CarPark.HQServerOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("toggle_entry_gate", new java.lang.Integer (5));
    _methods.put ("toggle_paystation", new java.lang.Integer (6));
    _methods.put ("toggle_exit_gate", new java.lang.Integer (7));
    _methods.put ("toggle_local_server", new java.lang.Integer (8));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 5:  // CarPark/HQServer/toggle_entry_gate
       {
         this.toggle_entry_gate ();
         out = $rh.createReply();
         break;
       }

       case 6:  // CarPark/HQServer/toggle_paystation
       {
         this.toggle_paystation ();
         out = $rh.createReply();
         break;
       }

       case 7:  // CarPark/HQServer/toggle_exit_gate
       {
         this.toggle_exit_gate ();
         out = $rh.createReply();
         break;
       }

       case 8:  // CarPark/HQServer/toggle_local_server
       {
         this.toggle_local_server ();
         out = $rh.createReply();
         break;
       }
