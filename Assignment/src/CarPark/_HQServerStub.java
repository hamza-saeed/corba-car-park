...
public class _HQServerStub extends org.omg.CORBA.portable.ObjectImpl implements CarPark.HQServer
{
  ...
  public CarPark.Machine[] returnEntryGates ()
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("returnEntryGates", true);
                $in = _invoke ($out);
                ...
                return returnEntryGates (        );
            } finally {
                _releaseReply ($in);
            }
  } // returnEntryGates

  public CarPark.Machine[] returnPayStations ()
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("returnPayStations", true);
                $in = _invoke ($out);
                ...
                return returnPayStations (        );
            } finally {
                _releaseReply ($in);
            }
  } // returnPayStations

  public CarPark.Machine[] returnExitGates ()
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("returnExitGates", true);
                $in = _invoke ($out);
  ...
  public void toggle_entry_gate ()
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("toggle_entry_gate", true);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
  ...
  public void toggle_exit_gate ()
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("toggle_exit_gate", true);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
  ...
  public void toggle_local_server ()
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("toggle_local_server", true);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
