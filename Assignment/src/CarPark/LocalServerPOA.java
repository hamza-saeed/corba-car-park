 ...
 implements CarPark.LocalServerOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("getCost", new java.lang.Integer (18));
    _methods.put ("setCost", new java.lang.Integer (19));
    _methods.put ("returnNumberofSpaces", new java.lang.Integer (20));
    _methods.put ("returnAvailableSpaces", new java.lang.Integer (21));
    _methods.put ("getParkingTransaction", new java.lang.Integer (22));
    _methods.put ("isEntryNameUnique", new java.lang.Integer (23));
    _methods.put ("isPayStationNameUnique", new java.lang.Integer (24));
    _methods.put ("isExitGateNameUnique", new java.lang.Integer (25));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 18:  // CarPark/LocalServer/getCost
       {
         double $result = (double)0;
         $result = this.getCost ();
         out = $rh.createReply();
       ...
       case 19:  // CarPark/LocalServer/setCost
       {
       ...
       case 20:  // CarPark/LocalServer/returnNumberofSpaces
       {
       ...
       case 21:  // CarPark/LocalServer/returnAvailableSpaces
       {
         short $result = (short)0;
       ...
       case 22:  // CarPark/LocalServer/getParkingTransaction
       {
         String reg = in.read_string ();
         CarPark.ParkingTransaction $result = null;
       ...
       case 23:  // CarPark/LocalServer/isEntryNameUnique
       {
       ...
       case 24:  // CarPark/LocalServer/isPayStationNameUnique
       {
         String name = in.read_string ();
         boolean $result = false;
       ...
       case 25:  // CarPark/LocalServer/isExitGateNameUnique
       {
         String name = in.read_string ();
         boolean $result = false;
