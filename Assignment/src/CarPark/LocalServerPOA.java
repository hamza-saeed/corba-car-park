 ...
 implements CarPark.LocalServerOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("_get_logOfEntryGates", new java.lang.Integer (2));
    _methods.put ("registerLocalServer", new java.lang.Integer (3));
    _methods.put ("vehicle_in", new java.lang.Integer (4));
    _methods.put ("vehicle_out", new java.lang.Integer (5));
    _methods.put ("vehicle_paid", new java.lang.Integer (6));
    _methods.put ("add_Ticket", new java.lang.Integer (7));
    _methods.put ("vehicle_in_car_park", new java.lang.Integer (8));
    _methods.put ("vehicle_already_paid", new java.lang.Integer (9));
    _methods.put ("return_cash_total", new java.lang.Integer (10));
    _methods.put ("add_entry_gate", new java.lang.Integer (11));
    _methods.put ("add_exit_gate", new java.lang.Integer (12));
    _methods.put ("add_pay_station", new java.lang.Integer (13));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 2:  // CarPark/LocalServer/_get_logOfEntryGates
       {
         CarPark.Machine $result[] = null;
         $result = this.logOfEntryGates ();
         out = $rh.createReply();
         CarPark.List_of_entryGatesHelper.write (out, $result);
         break;
       }

       case 3:  // CarPark/LocalServer/registerLocalServer
       {
       ...
       case 6:  // CarPark/LocalServer/vehicle_paid
       {
         CarPark.VehicleEvent event = CarPark.VehicleEventHelper.read (in);
       ...
       case 7:  // CarPark/LocalServer/add_Ticket
       {
       ...
       case 8:  // CarPark/LocalServer/vehicle_in_car_park
       {
       ...
       case 9:  // CarPark/LocalServer/vehicle_already_paid
       {
         String registration_number = in.read_string ();
         boolean $result = false;
       ...
       case 11:  // CarPark/LocalServer/add_entry_gate
       {
       ...
       case 12:  // CarPark/LocalServer/add_exit_gate
       {
         CarPark.Machine machine = CarPark.MachineHelper.read (in);
       ...
       case 13:  // CarPark/LocalServer/add_pay_station
       {
         CarPark.Machine machine = CarPark.MachineHelper.read (in);
