 ...
 implements CarPark.LocalServerOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("vehicle_already_paid", new java.lang.Integer (7));
    _methods.put ("return_cash_total", new java.lang.Integer (8));
    _methods.put ("add_entry_gate", new java.lang.Integer (9));
    _methods.put ("add_exit_gate", new java.lang.Integer (10));
    _methods.put ("add_pay_station", new java.lang.Integer (11));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 7:  // CarPark/LocalServer/vehicle_already_paid
       {
         String registration_number = in.read_string ();
         boolean $result = false;
       ...
       case 8:  // CarPark/LocalServer/return_cash_total
       {
       ...
       case 9:  // CarPark/LocalServer/add_entry_gate
       {
       ...
       case 10:  // CarPark/LocalServer/add_exit_gate
       {
         String gate_name = in.read_string ();
         String gate_ior = in.read_string ();
       ...
       case 11:  // CarPark/LocalServer/add_pay_station
       {
