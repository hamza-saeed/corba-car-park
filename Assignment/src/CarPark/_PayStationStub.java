...
public class _PayStationStub extends org.omg.CORBA.portable.ObjectImpl implements CarPark.PayStation
{
  ...
  public void registerPaystation (String machineName, String ior, CarPark.LocalServer lserverRef)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                CarPark.LocalServerHelper.write ($out, lserverRef);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                ...
                registerPaystation (machineName, ior, lserverRef        );
            } finally {
                _releaseReply ($in);
            }
  } // registerPaystation
  ...
  public boolean pay (String carReg, CarPark.Date payDate, CarPark.Time payTime, int duration, double amountPaid)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                return pay (carReg, payDate, payTime, duration, amountPaid        );
            } finally {
                _releaseReply ($in);
            }
  } // pay
