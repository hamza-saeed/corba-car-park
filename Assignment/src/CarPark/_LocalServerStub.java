...
public class _LocalServerStub extends org.omg.CORBA.portable.ObjectImpl implements CarPark.LocalServer
{
  ...
  public void registerLocalServer (String machineName, String ior, CarPark.HQServer hqRef)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                CarPark.HQServerHelper.write ($out, hqRef);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                ...
                registerLocalServer (machineName, ior, hqRef        );
            } finally {
                _releaseReply ($in);
            }
  } // registerLocalServer

  public void vehicle_in (CarPark.ParkingTransaction transaction)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
