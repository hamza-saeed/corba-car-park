 ...
 implements CarPark.PayStationOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("registerPaystation", new java.lang.Integer (2));
    _methods.put ("toggleEnabled", new java.lang.Integer (3));
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // CarPark/PayStation/_get_machine
       {
       ...
       case 1:  // CarPark/PayStation/_get_machine_name
       {
         String $result = null;
       ...
       case 2:  // CarPark/PayStation/registerPaystation
       {
       ...
       case 3:  // CarPark/PayStation/toggleEnabled
       {
         this.toggleEnabled ();
         out = $rh.createReply();
         break;
       ...
       case 5:  // CarPark/PayStation/pay
       {
         ...
         this.pay (carReg, duration, amountPaid);
         out = $rh.createReply();
         break;
       }
