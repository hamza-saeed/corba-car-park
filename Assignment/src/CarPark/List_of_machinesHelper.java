...
/**
* CarPark/List_of_machinesHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from CarPark.idl
* Wednesday, 3 April 2019 19:58:29 o'clock BST
*/

abstract public class List_of_machinesHelper
{
  private static String  _id = "IDL:CarPark/List_of_machines:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (CarPark.List_of_machinesHelper.id (), "List_of_machines", __typeCode);
    }
    return __typeCode;
  }
